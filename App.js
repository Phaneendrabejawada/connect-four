              ...
              return (
                <div>
                  ...
                  <ul>
                    ...
                    <li>If same color occurs in a sequence of four either horizontal or vertical or diagonal then the palyer wins</li>
                  </ul>
                </div>
              )
            }
            ...
            () => {
              return (
                <div>
                  ...
                  <button type="button" onClick={this.start} class="btn btn-success">Start Game...</button>
